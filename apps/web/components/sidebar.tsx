import { Activity, Bot, BrainCircuit, HeartPulse, Home, Settings, Table2, Trophy, Users } from "lucide-react";
  ...
  return (
    <aside className="sidebar">
      <Link className="brand" href="/dashboard">
        <span>
          <span className="brand-kicker">Raceweek</span>
          <span className="brand-title">Strategist</span>
        </span>
      </Link>
