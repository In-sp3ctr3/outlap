...
| Engineering | Remaining v1 slices | Unit/API/web/e2e tests per milestone | Connectors, full projection engine, OR-Tools path, real provider adapters, complete UI states, release gates | `docs/14_IMPLEMENTATION_PLAN.md`, `docs/20_IMPLEMENTATION_CHECKLIST.md` | in progress |
